...
def lambda_handler(event, context):
    ...
    try:
        ...
        message = json.loads(decode_response)
        print(message)
        conv = message['text']
        text = {}
        #id=message['user_id']
    ...
    tone = tone_analyzer.tone(text, tones='emotion', content_type='application/json')
    ...
    BODY_TEXT =  (tone['document_tone']['tones'][0]['tone_id'])
    print(BODY_TEXT)
    CHARSET = "UTF-8"
        ...
        response = client.send_email(
            ...
            Message={
                'Body': {
                    'Text': {
                        'Charset': CHARSET,
                        'Data': tone['document_tone']['tones'][0]['tone_id'],
                    },
                },
                'Subject': {
                    'Charset': CHARSET,
